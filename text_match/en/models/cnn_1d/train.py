...
from text_match.en.models.cnn_1d.cnn_model import Cnn_1d
import datetime
import os
import time
...
def train(x_train1, x_dev1, x_train2, x_dev2, y_train, y_dev, word_embedding, max_len, vocab_size):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            cnn = Cnn_1d(FLAGS.learning_rate, FLAGS.batch_size, FLAGS.decay_steps, FLAGS.decay_rate,
                         max_len,
            ...
            checkpoint_dir = os.path.abspath(os.path.join(os.path.curdir, "checkpoint", timestamp))
