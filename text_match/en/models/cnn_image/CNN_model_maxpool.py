...
class cnn_text:
    ...
    def inference(self):
        ...
        with tf.variable_scope("conv1"):
            ...
            self.pool1 = tf.layers.max_pooling2d(self.activ1, pool_size=2, strides=[2, 2], padding="SAME",
                                                 name="pool")
        ...
        with tf.variable_scope("conv2"):
            ...
            self.pool2 = tf.layers.max_pooling2d(self.activ2, pool_size=2, strides=[2, 2], padding="SAME",
                                                 name="pool")
