...
def predict(x_pre1, x_pre2):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            checkpoint_dir = os.path.abspath(os.path.join(os.path.curdir, "checkpoint", "1532790390batch64"))
            model_path = os.path.join(checkpoint_dir, "model-30100.meta")
...
if __name__ == '__main__':
    ...
    file_name = timestamp + "result_cnn_image.txt"
