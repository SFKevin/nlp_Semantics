...
from CIKM.models.RNN_dot.rnn_model import rnn_dot
import os
import time
...
def predict(x_pre1, x_pre2):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            checkpoint_dir = os.path.abspath(os.path.join(os.path.curdir, "checkpoint", "1532617736_bn"))
            model_path = os.path.join(checkpoint_dir, "model-30000.meta")
            ...
            logits = sess.run(result, {"is_training:0": False, "input_x1:0": x_test1, "input_x2:0": x_test2,
...
if __name__ == '__main__':
    ...
    file_name = timestamp + "result_rnn_bn.txt"
