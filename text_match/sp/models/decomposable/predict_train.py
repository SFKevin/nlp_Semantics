...
if __name__ == '__main__':
    x_train1, x_train1, _, _, _, _, word_embedding, max_len, vocab_size, x_test1, x_test2 = process()
    result = predict(x_train1, x_train1)
    timestamp = str(int(time.time()))
    file_name = timestamp + "train_decom.txt"
