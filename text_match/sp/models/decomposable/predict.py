    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            checkpoint_dir = os.path.abspath(
                os.path.join(os.path.curdir, "checkpoint", "1532829904"))
            model_path = os.path.join(checkpoint_dir, "model-31600.meta")
            ...
            logits = sess.run(result, {"is_training:0": False, "input_x1:0": x_test1, "input_x2:0": x_test2,
                                       "dropout_keep_prob:0": 1.0, "weights_place:0": weights})
...
if __name__ == '__main__':
    ...
    file_name = timestamp + "result_decom.txt"
