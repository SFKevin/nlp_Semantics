...
from CIKM.models.decomposable.decomp_atten import depos_atten
import datetime
import os
import time
...
def process():
    ...
    # x_train1 = np.array(x_text1_int)
    # x_train2 = np.array(x_text2_int)
...
def train(x_train1, x_dev1, x_train2, x_dev2, y_train, y_dev, word_embedding, max_len, vocab_size):
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            rnn = depos_atten(FLAGS.learning_rate, FLAGS.batch_size, FLAGS.decay_steps, FLAGS.decay_rate,
                              max_len,
            ...
            def train_step(x_batch1, x_batch2, y_batch):
                ...
                feed_dict = {rnn.is_training: True, rnn.input_x1: x_batch1, rnn.input_x2: x_batch2,
                             rnn.input_y: y_batch,
                             rnn.dropout_keep_prob: FLAGS.dropout_keep_prob, rnn.weights1: weights_t}
            ...
            def dev_step(x_batch1, x_batch2, y_batch):
                ...
                feed_dict = {rnn.is_training: False, rnn.input_x1: x_batch1, rnn.input_x2: x_batch2,
                             rnn.input_y: y_batch,
                             rnn.dropout_keep_prob: 1.0, rnn.weights1: weights_d}
