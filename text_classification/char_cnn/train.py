...
tf.flags.DEFINE_string("positive_data_file", "E:\\data\\rt-polaritydata\\rt-polarity.pos",
                       "positive_data_file not found ")
tf.flags.DEFINE_string("negative_data_file", "E:\\data\\rt-polaritydata\\rt-polarity.neg",
...
def train(x_train, y_train, maxlen, x_dev, y_dev):
    """
    Training
    :param x_train:
    :param y_train:
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            cnn = charCNN.CharCNN(l0=maxlen, num_classes=y_train.shape[1],
...
if __name__ == '__main__':
    ...
    train(x_train, y_train,maxlen, x_dev, y_dev)
