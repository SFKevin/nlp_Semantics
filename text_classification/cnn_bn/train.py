...
from cnn_bn.text_cnn import TextCNN
from tflearn.data_utils import pad_sequences

tf.flags.DEFINE_string("positive_data_file", "E:\\data\\rt-polaritydata\\rt-polarity.pos", "positive_data_file not found ")
tf.flags.DEFINE_string("negative_data_file", "E:\\data\\rt-polaritydata\\rt-polarity.neg", "negative_data_file not found")
...
tf.flags.DEFINE_string("word2vec_model_path", "E:\\data\\GoogleNews-vectors-negative300\\GoogleNews-vectors-negative300.bin", "Goole News Vector")
...
def train(x_train, y_train, vocab_processor, x_dev, y_dev, word_embeddings):
    ...
    with tf.Graph().as_default():
        ...
        with sess.as_default():
            ...
            def dev_step(x_batch, y_batch, iteration, writer=None):
                feed_dict = {cnn.input_x: x_batch, cnn.input_y: y_batch, cnn.dropout_keep_prob: 1.0,
                             cnn.dropout_keep_prob: FLAGS.dropout_keep_prob, cnn.iter: iteration,
                             cnn.tst: True}
            ...
            for batch in batches:
                ...
                train_step(x_batch, y_batch, iteration)
                current_step = tf.train.global_step(sess, global_step)
                if current_step % FLAGS.evaluate_every == 0:
                    print("\nEvaluation:")
                    dev_step(x_dev, y_dev, iteration, writer=dev_summary_writer)
                    print("")
